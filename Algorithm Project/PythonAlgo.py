...
class IndicatorSuiteAlgorithm(QCAlgorithm):
    ...
    def Initialize(self):
        ...
        # suppose we seek the ratio of BTC to AAPL, we could write the following:
        aaplClose = Identity(self.symbol)
        aaplClose = Identity(self.customSymbol)

        # this will create a new indicator whose value is FB/AAPL
        self.ratio = IndicatorExtensions.Over(aaplClose, aaplClose)
    ...
    def OnData(self, data):
        ...
        if not self.Portfolio.HoldStock:
            ...
            self.Debug('Purchased AAPL on ' + self.Time.strftime('%Y-%m-%d'))
    ...
    def update_plots(self):
        ...
        # Custom data indicator
        self.Plot('RSI-AAPL', self.rsiCustom)
